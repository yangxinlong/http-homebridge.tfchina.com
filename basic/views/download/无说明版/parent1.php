...
<a href="<?php if($if_wx){?>javascript:display_tips();<?php }else{ ?>/download/hbj.apk<?php }?>"><img class="width_load" src="images/jz_zj.png"   /></a>

 <a href="http://home.tfchina.com"><img class="width_load" src="images/jz_zjweb.png"   /></a>
