...
<div class="butten">
<a href="<?php if($if_wx){?>javascript:display_tips();<?php }else{ ?>/download/hbj.apk<?php }?>"><img src="images/img/butten1.png"></a>
</div>
				<div class="butten" >
                    <a href="http://home.tfchina.com"><img src="images/img/butten2.png"></a>
                </div>
            </div>
        </div>
    </div>
