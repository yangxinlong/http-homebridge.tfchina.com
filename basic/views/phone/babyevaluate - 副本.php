...
<div id="top_new">
    <div id="month_choose">
        <div class="m_imgleft"><img id="monthleft" onClick="monthevlleft()" src="images/month_left.jpg"></div>
        <div class="m_c" id="m_c"></div>
        <div class="m_imgright"><img id="monthright" onClick="monthevlright()" src="images/month_right.jpg"></div>
    </div>
    <?php if ($webtype == 3) {
        foreach ($eva as $k => $v) {
            ?>
            <a href=<?php echo SiteCom::$phone_url . "detail&webtype=3&id=" . $v->id ?>>
                <div class="detail_article border_bottom1">
                    <div class="top_img"><img src="<?= SiteCom::getRoleImg($v->author_role_id) ?>"></div>
...
<div id="aboutme">
    <div id="month_choose">
        <div class="m_imgleft"><img onClick="yearevlleft()" src="images/month_left.jpg"></div>
        <div class="m_c" id="m_year"></div>
        <div class="m_imgright"><img onClick="yearevlright()" src="images/month_right.jpg"></div>
    </div>
