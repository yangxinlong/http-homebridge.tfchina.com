  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    ...
    <?php foreach ($article_list as $kk => $vv) { ?>
        <tr>
            ...
            <td>
                <a href="javascript:if(confirm('确定删除')){window.location.href='index.php?r=manage/article/delete&id=<?= $vv['id'] ?>';}"><span
                        class="glyphicon glyphicon-trash"></span> 删除</a>
                <a href="index.php?r=manage/article/view&id=<?= $vv['id'] ?>"><span
